...
tt.__init__()
while tt.during(1):  # 10s内捕捉鼠标当前位置的颜色
    tt.sleep(1)
    ...
    dm.FreePic("C:123.bmp")
    dm.SetDisplayInput("pic:123.bmp")
    r = dm.FindMultiColor(0,0,1377,806,
                      "5896c1","4|0|181818,9|3|cca77b,8|5|181818,13|0|cccccc,16|9|181818,29|0|181818,32|9|187ca9",
                      1, 0)
    x, y = r[1], r[2]
    print(x)
    print(y)
    ms.move_to(x/1.75, y/1.75)
    tt.sleep(0.5)
    ms.click_left(x/1.75, y/1.75)
