...
from bdtime import tt, vk, Time
from pydamo.regsvr import RegDM, run_in_bat
...
class DM:
    ...
    def FindMultiColor(self, x1, y1, x2, y2, first_color, offset_color, sim, dir):
        return self.dm.FindMultiColor(x1, y1, x2, y2, first_color, offset_color, sim, dir, 0, 0)
